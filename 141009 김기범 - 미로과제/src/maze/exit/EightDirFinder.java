...
public class EightDirFinder extends BaseStrategy implements ExitStrategy{
	
	private int nextRow, nextCol;

	
	/* 생성자 */
	protected EightDirFinder(){}
	public EightDirFinder(Cell[][] maze){
		this.maze = maze;
